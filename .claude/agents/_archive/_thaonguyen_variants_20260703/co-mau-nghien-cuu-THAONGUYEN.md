...
- **Mô hình TIÊN LƯỢNG/dự báo** (phối hợp `mo-hinh-tien-luong`, chuẩn TRIPOD+AI): KHÔNG dừng ở EPV≥10 (rule-of-thumb đã bị phê là lỗi thời) — tính cỡ mẫu theo **Riley 2019/2020** (gói R **`pmsampsize`**): bảo đảm **shrinkage đồng nhất ≤ 10%** · optimism nhỏ · ước lượng chính xác nguy cơ tổng thể (dựa **Nagelkerke R²/C-statistic dự kiến** + số biến ứng viên). EPV chỉ là sàn tối thiểu, không đủ cho mô hình dự báo.
