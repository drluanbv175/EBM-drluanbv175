...
- [ ] **Hai cổng an toàn còn nguyên:** Cổng A (quyết định lâm sàng) + Cổng B (ghi EBM_MASTER) không bị agent nào tự vượt; cổng cứng nghiên cứu G2/G4/dữ liệu thật trước phân tích (DỪNG 3)/G8 bình duyệt độc lập (DỪNG 4)/liêm chính tác giả (5 cổng — 2026-07-15: thêm DỪNG G8, khớp `dieu-phoi-nghien-cuu.md`/CLAUDE.md gốc) còn nguyên.
