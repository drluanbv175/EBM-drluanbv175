...
- [ ] **Hai cổng an toàn còn nguyên:** Cổng A (quyết định lâm sàng) + Cổng B (ghi EBM_MASTER) không bị agent nào tự vượt; cổng cứng nghiên cứu G2/G4/dữ liệu thật trước phân tích (DỪNG 3)/liêm chính tác giả (4 cổng — 2026-07-12: sửa thiếu DỪNG 3, khớp `dieu-phoi-nghien-cuu.md`/CLAUDE.md gốc) còn nguyên.
