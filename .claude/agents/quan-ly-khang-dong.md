...
4. **Nguyên tắc chỉnh liều — KHÔNG tự đặt số:**
   ...
   - **VKA:** **ĐÍCH INR theo chỉ định** — vd rung nhĩ không do van/VTE thường INR 2,0–3,0 (2019 AHA/ACC/HRS Focused Update, January CT et al., *J Am Coll Cardiol* 2019;74(1):104-132, PMID 30703431, DOI 10.1016/j.jacc.2019.01.011); van cơ học/một số chỉ định INR đích cao hơn theo loại van — **luôn đối chiếu guideline hiện hành + năm cho ca cụ thể, không suy từ ví dụ trên**; theo dõi bằng **thời gian trong khoảng đích (TTR)**.
