...
CORE_CHECKS: List[EvidenceCheck] = [
    ...
    EvidenceCheck(
        ...
        proves="Guardrail trả về sửa khi thiếu CI; automation không tự duyệt; role sai bị chặn; review nhiều vai trò chỉ hoàn tất khi đủ PI/IRB/thống kê viên/phản biện; G2/G4/G9 cần IRB/thống kê viên/PI; thống kê xuất effect size/CI và có DATA LOCK.",
