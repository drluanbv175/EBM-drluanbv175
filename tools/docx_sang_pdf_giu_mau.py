...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        # encoding/errors (16/09/2026, hợp nhất với f996aea đã có trên master):
        # thiếu 2 tham số này làm thread đọc stdout crash im lặng trên Windows
        # (subprocess trả bytes thay vì str khi hệ thống không phải UTF-8 mặc định).
