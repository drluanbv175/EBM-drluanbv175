...
Mỗi miền chấm **nguy cơ sai lệch** (thấp/không rõ/cao); riêng **tính áp dụng CHỈ đánh giá cho 3 miền đầu** — chọn bệnh nhân/index test/reference standard — theo đúng thiết kế gốc của công cụ (Whiting 2011, PMID 22007046); miền **"Dòng chảy & thời điểm" KHÔNG có phán định tính áp dụng**. Mỗi miền cần dẫn chứng vị trí trong bài:
...
Chấm mức độ NGHIÊM TRỌNG từng domain (risk of bias qua **QUADAS-2**, indirectness, imprecision, inconsistency, publication bias — 0=không/1=nghiêm trọng/2=rất nghiêm trọng), rồi gọi:
...
- CHỈ thẩm định độ chính xác của MỘT nghiên cứu chẩn đoán (QUADAS-2/QUADAS-C + GRADE-cho-test + STARD).
