...
- **Nguồn uy tín lõi cho chứng cứ mới:** khi cập nhật chứng cứ, hệ thống phải ưu tiên registry nguồn chính thức/tin cậy cao (Cochrane, USPSTF/NICE/WHO/CDC/FDA/EMA/MHRA, NEJM/Lancet/JAMA/BMJ/Annals/Nature Medicine, và các hiệp hội chuyên khoa như ACC/AHA, ESC, ADA/EASD, KDIGO, GINA, GOLD, IDSA, EULAR/ACR, ACG/AGA/ASGE, AASLD/EASL, ASH/ISTH, AGS, ATS/ERS/BTS). Registry chỉ tăng ưu tiên thẩm định; không tự nâng editorial/preprint/tín hiệu yếu thành khuyến cáo áp dụng.
