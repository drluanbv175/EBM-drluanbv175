...
2. **Sức khoẻ toàn hệ:** `python3 tools/chu_trinh_chung_cu.py --nhanh` · chốt hồi quy `python3 tools/chot_hoi_quy_bai_hoc.py` (bộ chốt BH tự chạy mỗi phiên — con số hiện hành in ở đầu phiên).
